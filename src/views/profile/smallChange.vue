<template>
  <div class="w myOddBalance">
    <div class="oddBalanceHeader">
      <p class="title">零头结余</p>
      <router-link class="check" to="/index/help/balance" >查看计算细则></router-link>
    </div>
    <div class="oddContent">
      <p class="balanceNumber fw-b fz32 c-red">{{oddBalanceAmount}}<span class="fz16 fw-b">元</span></p>
      <p class="tips"><i></i>零头结余由来：为解决零头支付不便问题，在您下单时，系统自动将本次订单应付金额与零头结余相加，计算后金额的零头为新的零头结余，并于下次下单时 一并结算。</p>
